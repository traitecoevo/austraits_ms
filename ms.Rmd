...
- traits now widely agreed as important [@westoby2002]
...
-	Web portal, maybe like coral traits, for easily adding new data which can accommodate a range of user’s capabilities
...
The data are housed within github repository traitecoevo with sequential releases being made available on this platform and Zenodo/Figshare. Access to Austraits will be  XXX. Austraits can also be accessed via the R package: `austraits`
